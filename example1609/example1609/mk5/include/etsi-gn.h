...
{
  /// GN lifetime default
  ETSI_GN_LT_DEFAULT = 0,
  /// GN lifetime of 1 second (as used in SHB transport)
  ETSI_GN_LT_1SEC = 1000,
...
/**
 * @brief Set GN-layer maximum transmit power
 *        A single controller is expected to use this API (not thread safe)
 * @param MaxTxPowerHdBm Maximum allowed transmit power (in half-dBm steps)
 */
void ETSIGN_SetMaxTxPower (int8_t MaxTxPowerHdBm);
