...
{
  /// PPP Priority 1
  ETSI_PC5_PPPPRIORITY_1 = 0, // highest priority
  /// PPP Priority 2
  ETSI_PC5_PPPPRIORITY_2 = 1,
  /// PPP Priority 3
  ETSI_PC5_PPPPRIORITY_3 = 2,
  /// PPP Priority 4
  ETSI_PC5_PPPPRIORITY_4 = 3,
  /// PPP Priority 5
  ETSI_PC5_PPPPRIORITY_5 = 4,
  /// PPP Priority 6
  ETSI_PC5_PPPPRIORITY_6 = 5,
  /// PPP Priority 7
  ETSI_PC5_PPPPRIORITY_7 = 6,
  /// PPP Priority 8
  ETSI_PC5_PPPPRIORITY_8 = 7, // lowest priority
