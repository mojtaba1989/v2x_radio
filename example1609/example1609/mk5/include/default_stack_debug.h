...
extern "C"
{
  ...
  // Cohda_Stack.fac_its.etsi_avm.DebugLevel
  extern int default_stack_Cohda_Stackfac_its_etsi_avm_DebugLevel;
  ...
  // Cohda_Stack.fac_its.etsi_poi.DebugLevel
  extern int default_stack_Cohda_Stackfac_its_etsi_poi_DebugLevel;
  ...
  // Cohda_Stack.plat.conf.DebugLevel
  extern int default_stack_Cohda_Stackplat_conf_DebugLevel;
  // Cohda_Stack.plat.conf.conf.DebugLevel
  extern int default_stack_Cohda_Stackplatconf_conf_DebugLevel;
  // Cohda_Stack.plat.conf.conf_cmd.DebugLevel
  extern int default_stack_Cohda_Stackplatconf_conf_cmd_DebugLevel;
  // Cohda_Stack.plat.conf.conf_pluggable.DebugLevel
  extern int default_stack_Cohda_Stackplatconf_conf_pluggable_DebugLevel;
  // Cohda_Stack.plat.conf.conf_thr.DebugLevel
  extern int default_stack_Cohda_Stackplatconf_conf_thr_DebugLevel;
  ...
  // Cohda_Stack.fac_1609.j2735.j29454_rsm.DebugLevel
  extern int default_stack_Cohda_Stackfac_1609j2735_j29454_rsm_DebugLevel;
