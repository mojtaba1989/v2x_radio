...
/// TS103882 defined AVM AID (71)
#define C2XSEC_ITS_AID_AVM 0x47
...
/// TS103916 defined POI AID (1619)
#define C2XSEC_ITS_AID_POI 0x0653
...
/// Define size (in bytes) of DENM v1 SSP bits
#define C2XSEC_DENM_SSPV1_LEN 4

/// Define size (in bytes) of DENM SSP bits
#define C2XSEC_DENM_SSP_LEN 5

/// Define size (in bytes) of AVM SSP bits
#define C2XSEC_AVM_SSP_LEN 0
...
/// Define size (in bytes) of POI SSP bits
#define C2XSEC_POI_SSP_LEN 1
