...
typedef enum C2CImpactSection {
  C2CImpactSection_rear = 0,
  C2CImpactSection_front = 1,
  C2CImpactSection_sideLeftFront = 2,
  C2CImpactSection_sideLeftBack = 3,
  C2CImpactSection_sideRightFront = 4,
  C2CImpactSection_sideRightBack = 5,

  C2CImpactSection_doNotInclude = 6
} eC2CImpactSection;

/// C2C PreCrash ImpactSection type @ref C2CImpactSection
typedef uint8_t tC2CImpactSection;

typedef enum C2CEstimatedBrakingDistance {
  C2CEstimatedBrakingDistance_oneCentimetre = 1,
  C2CEstimatedBrakingDistance_oneMetre = 100,

  C2CEstimatedBrakingDistance_doNotInclude = 40951
} eC2CEstimatedBrakingDistance;

/// C2C PreCrash EstimatedBrakingDistance type @ref C2CEstimatedBrakingDistance
typedef uint16_t tC2CEstimatedBrakingDistance;
...
typedef struct C2CPreCrashContainer {
  ...
  /// Estimated braking distanceAbsolute (cm) for ego
  tC2CEstimatedBrakingDistance estimatedBrakingDistance_cm;
