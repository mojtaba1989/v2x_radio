...
typedef struct J2735Msg
{
  ...
  union
  {
    ...
    SAERoadSafetyMessage           *pRSM;
    SAERoadWeatherMessage          *pRWM;
    SAEProbeDataConfigMessage      *pPDCM;
    SAEProbeDataReportMessage      *pPDRM;
    SAETollAdvertisementMessage    *pTAM;
    SAETollUsageMessage            *pTUM;
    SAETollUsageAckMessage         *pTUMAck;
    SAECooperativeControlMessage   *pCCM;
    SAESensorDataSharingMessage    *pSDSM;
    SAEManeuverSharingAndCoordinatingMessage *pMSCM;
    SAERoadGeometryAndAttributes   *pRGA;
    SAEPersonalSafetyMessage2      *pPSM2;
    SAETrafficSignalPhaseAndTiming *pTSPT;
    SAESignalControlAndPrioritizationRequest *pSCPR;
    SAESignalControlAndPrioritizationStatus *pSCPS;
    SAERoadUserChargingConfigMessage *pRUCCM;
    SAERoadUserChargingReportMessage *pRUCCR;
    SAETrafficLightStatusMessage   *pTLSM;
  };
} tJ2735Msg;
