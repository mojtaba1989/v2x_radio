...
typedef union VSC3OBE_VSTATE_OBE3
{
    ...
    struct
    {
        ...
        uint16_t AccelPos:8;
        ///32
        /// [0.125, 0] [-16, 15.875] 1_per_8_deg
        /// Road Slope
        int16_t Slope_deg8:8;
        uint64_t pad_50:10;
        ///50
        /// [1, 0] [0, 1]
        /// Low Beam Status
...
#define VSC3OBE_VSTATE_OBE3_NUM_ELEMENTS 15
...
#define VSC3OBE_VSTATE_OBE3_Slope_deg8_raw_TO_1_per_8_deg(r)   ((r) / 8)
#define VSC3OBE_VSTATE_OBE3_Slope_deg8_1_per_8_deg_TO_raw(u)   ((u) * 8)
