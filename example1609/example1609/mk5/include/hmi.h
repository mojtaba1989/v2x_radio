...
typedef enum
{
  ...
  HMI_ALERT_TYPE_GREEN_PHASE = 13, ///< TLI Phase
  HMI_ALERT_TYPE_YELLOW_PHASE = 14, ///< TLI Phase
  HMI_ALERT_TYPE_RED_PHASE = 15, ///< TLI Phase
...
tHMIErrCode HMI_Open (tHMI **ppHMI,
                      tHMIGetHeartBeatInfoFunc GetHeartBeatInfo,
                      void *pGetHeartBeatInfoPriv);
